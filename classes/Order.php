<?php
    class Order{
        ...
        public function getOrderList(){
            $sql = "SELECT ord.orderID, p.productID, p.name, i.img1, p.price, ordz.quantity, p.rating, p.sold
        ...
        public function getItemList($orderID){
            $sql = "SELECT p.productID, p.name, i.img1, p.price, ordz.quantity, p.rating, p.sold
